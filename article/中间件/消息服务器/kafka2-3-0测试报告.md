...
max.block.ms=10000
```
生产者部署: 分别部署三台物理机器, coreSize=16的线程池分80000次发送一批1000条*100Byte的数据.

### 2.1.2 生产者端

三个生产者往kafka单机提交8kw条100Byte的消息, 耗时如下
...
![](img/4039130-8a11b5a1a4bc6cc0.png)
...
![](img/4039130-67e6508e706a1138.png)
...
2个producer全力输出
![2个producer全力输出](img/4039130-7dae6644b11f9abc.png)

3个producer全力输出
![3个producer全力输出](img/4039130-9bdb47105bb3bf83.png)

6个producer全力输出
![](img/4039130-d698b2d695fe2c97.png)
...
![](img/4039130-11b6bab82d7f2ed1.png)
...
![](img/4039130-6fb10119e4349afa.png)
...
max.block.ms=10000
```
生产者部署: 分别部署9台, 其中3台物理机器以及6台JVM虚拟机, coreSize=16的线程池分90000次发送一批1000条*100Byte的数据, 总共发送81kw*100Byte条消息.

内网传输速度实测超过100MB/s, KVM虚拟机磁盘读写、cpu核心数、内存频率大小、网络传输速度等都比物理机低.
...
![](img/4039130-01521926a9252137.png)
...
![](img/4039130-b1da2a9ae83a934c.png)
---

# 九.最后

通过以上不够严谨的测试, 公司服务器环境下的kafka关键吞吐指标如下
1. 数据输入(写消息)
